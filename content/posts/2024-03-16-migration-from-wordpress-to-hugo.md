...
The code of this website is now [open-source], not only in the hope of inspiring others to do the same, but also to allow my readers to read the code and sugest changes.
